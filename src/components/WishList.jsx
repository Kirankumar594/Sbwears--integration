...
export default function WishList() {
  ...
  return (
    <div className=" max-w-4xl">
      <button className="ml-4 mr-5 px-3 py-2 text-black text-xs bg-white border border-black hover:bg-navyBLue hover:text-white"  >All</button>
      <button className="mb-5 px-3 py-2 text-black text-xs bg-white border border-black hover:bg-navyBLue hover:text-white"  >New</button>
            ...
            {products.map((product) => (
              ...
              > 
                {hoveredProduct === product.id && (
                  <button
                    className="absolute top-[-8px] right-[-8px] w-6 h-6   text-white   flex items-center justify-center z-10"
